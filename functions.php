...
function start_enqueue_scripts() {
  ...
  wp_enqueue_style(
    'google-fonts',
    'https://fonts.googleapis.com/css2?family=Kanit:wght@400;700&family=M+PLUS+Rounded+1c:wght@700&family=Noto+Sans+JP:wght@400;700;900&family=Noto+Serif+JP:wght@400;700;900&family=Zen+Kaku+Gothic+New:wght@400;700;900&family=Zen+Old+Mincho:wght@400;700&display=swap',
    array(),
    null,
    'all'
  );
